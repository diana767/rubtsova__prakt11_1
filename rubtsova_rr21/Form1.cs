...
namespace rubtsova_rr21
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(string.Format("Студент: {0}\nПервоначальный рост: {1}\nПервоначальный вес: {2}\nСъел еды: {3}кг\n Рост после еды {4}\nВес после еды {5}", student1.name, student1.rost, student1.GetEat(Convert.ToInt32(numericUpDown2.Value)), student1.GetEat(Convert.ToInt32(numericUpDown3.Value)), student1.SetRost(Convert.ToInt32(numericUpDown3.Value), student1.rost), student1.SetEat(Convert.ToInt32(numericUpDown3.Value), (Convert.ToDouble(numericUpDown2.Value)))));
        }
    }
}
